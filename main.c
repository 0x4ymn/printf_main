...
/////////////////////////////////
	ft_printf("------------%%c------------\n");
	char	ltr = 'C';
	output_OG = printf("OG -> L3alamia %c\n", ltr);
	output_FT = ft_printf("FT -> L3alamia %c\n", ltr);
	printf("OUTPUT OG = %d\n", output_OG);
	ft_printf("OUTPUT FT = %d\n", output_FT);
...
/////////////////////////////////
	ft_printf("------------%%s------------\n");
	char	*str = "Nassih";
	output_OG = printf("OG -> I'm Aymane %s\n", str);
	output_FT = ft_printf("FT -> I'm Aymane %s\n", str);
	printf("OUTPUT OG = %d\n", output_OG);
	ft_printf("OUTPUT FT = %d\n", output_FT);
	...
	char str2[] = "L7out l3ma, fdelma hh";
	output_OG = printf("OG -> %s\n", str2);
	output_FT = ft_printf("FT -> %s\n", str2);
	printf("OUTPUT OG = %d\n", output_OG);
	ft_printf("OUTPUT FT = %d\n", output_FT);
